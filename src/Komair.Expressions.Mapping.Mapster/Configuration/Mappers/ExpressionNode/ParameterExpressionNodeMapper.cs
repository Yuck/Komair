...
internal class ParameterExpressionNodeMapper(TypeAdapterConfig configuration) : ExpressionNodeMapperBase<ParameterExpressionNode, ParameterExpression>(configuration)
{
