...
internal class BinaryExpressionNodeMapper(TypeAdapterConfig configuration) : ExpressionNodeMapperBase<BinaryExpressionNode, BinaryExpression>(configuration)
{
