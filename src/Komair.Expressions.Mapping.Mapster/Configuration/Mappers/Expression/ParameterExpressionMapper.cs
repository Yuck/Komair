...
internal class ParameterExpressionMapper(TypeAdapterConfig configuration) : ExpressionMapperBase<ParameterExpression, ParameterExpressionNode>(configuration)
{
